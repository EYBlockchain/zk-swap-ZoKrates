...
{
  // vks
  std::vector<r1cs_se_ppzksnark_verification_key<ppT_F>> vks;
  {
    string raw_vk_path = string(vk_1_path).append(".raw");
    auto vk = loadFromFile<r1cs_se_ppzksnark_verification_key<ppT_F>>(raw_vk_path);
    vks.emplace_back(vk);
  }
  {
  ...
  // proofs
  std::vector<r1cs_se_ppzksnark_proof<ppT_F>> proofs;
  {
    string raw_proof_path = string(proof_1_path).append(".raw");
    auto proof = loadFromFile<r1cs_se_ppzksnark_proof<ppT_F>>(raw_proof_path);
  ...
  r1cs_se_ppzksnark_keypair<ppT> keypair = r1cs_se_ppzksnark_generator<ppT>(agg.pb.get_constraint_system());
  ...
  r1cs_se_ppzksnark_proof<ppT> proof = r1cs_se_ppzksnark_prover<ppT>(keypair.pk, primary_input, auxiliary_input);
    ...
    const char *agg_vk_path, const char *agg_proof_path)
{
  ...
  libff::mnt4_pp::init_public_params();
  libff::mnt6_pp::init_public_params();
  return gm17::batch<libff::mnt4_pp, libff::mnt6_q_limbs, libff::mnt6_r_limbs, libff::mnt6_pp, libff::mnt6_G1, libff::mnt6_G2>(vk_1_path, proof_1_path, vk_2_path, proof_2_path, vk_3_path, proof_3_path, agg_vk_path, agg_proof_path);
}
    ...
    const char *agg_vk_path, const char *agg_proof_path)
{
  ...
  libff::mnt6_pp::init_public_params();
  libff::mnt4_pp::init_public_params();
  return gm17::batch<libff::mnt6_pp, libff::mnt4_q_limbs, libff::mnt4_r_limbs, libff::mnt4_pp, libff::mnt4_G1, libff::mnt4_G2>(vk_1_path, proof_1_path, vk_2_path, proof_2_path, vk_3_path, proof_3_path, agg_vk_path, agg_proof_path);
}
    ...
    const char *agg_vk_path, const char *agg_proof_path)
{
  ...
  libff::mnt4753_pp::init_public_params();
  libff::mnt6753_pp::init_public_params();
  return gm17::batch<libff::mnt4753_pp, libff::mnt6753_q_limbs, libff::mnt6753_r_limbs, libff::mnt6753_pp, libff::mnt6753_G1, libff::mnt6753_G2>(vk_1_path, proof_1_path, vk_2_path, proof_2_path, vk_3_path, proof_3_path, agg_vk_path, agg_proof_path);
}
    ...
    const char *agg_vk_path, const char *agg_proof_path)
{
  ...
  libff::mnt6753_pp::init_public_params();
  libff::mnt4753_pp::init_public_params();
  return gm17::batch<libff::mnt6753_pp, libff::mnt4753_q_limbs, libff::mnt4753_r_limbs, libff::mnt4753_pp, libff::mnt4753_G1, libff::mnt4753_G2>(vk_1_path, proof_1_path, vk_2_path, proof_2_path, vk_3_path, proof_3_path, agg_vk_path, agg_proof_path);
}
