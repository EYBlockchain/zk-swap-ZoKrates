...
std::string outputPointG1AffineAsHex(G1T _p)
{
  ...
  if constexpr (std::is_same<G1T, libff::mnt4_G1>::value || std::is_same<G1T, libff::mnt6_G1>::value || std::is_same<G1T, libff::sw6_G1>::value) {
    return
      "0x" +
...
std::string outputPointG2AffineAsHex(G2T _p)
{
  G2T aff = _p;
  aff.to_affine_coordinates();
  if constexpr (std::is_same<G2T, libff::mnt4_G2>::value || std::is_same<G2T, libff::mnt6_G2>::value || std::is_same<G2T, libff::sw6_G2>::value) {
    return
      "[0x" +
