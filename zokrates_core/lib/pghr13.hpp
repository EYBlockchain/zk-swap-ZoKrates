...
bool _pghr13_mnt4753_setup(const uint8_t* A,
            const uint8_t* B,
            const uint8_t* C,
            int A_len,
            int B_len,
...
bool _pghr13_mnt4753_generate_proof(const char* pk_path,
            const char* proof_path,
            const uint8_t* public_inputs,
            int public_inputs_length,
            const uint8_t* private_inputs,
...
bool _pghr13_mnt4753_verify_proof(
        const char* vk_path,
        const char* proof_path
        );

bool _pghr13_mnt6753_setup(const uint8_t* A,
            const uint8_t* B,
            const uint8_t* C,
            int A_len,
            int B_len,
...
bool _pghr13_mnt6753_generate_proof(const char* pk_path,
            const char* proof_path,
            const uint8_t* public_inputs,
            int public_inputs_length,
            const uint8_t* private_inputs,
...
bool _pghr13_mnt6753_verify_proof(
        const char* vk_path,
        const char* proof_path
        );

bool _pghr13_edwards_setup(const uint8_t* A,
            const uint8_t* B,
            const uint8_t* C,
            int A_len,
            int B_len,
...
bool _pghr13_edwards_generate_proof(const char* pk_path,
            const char* proof_path,
            const uint8_t* public_inputs,
            int public_inputs_length,
            const uint8_t* private_inputs,
...
bool _pghr13_edwards_verify_proof(
        const char* vk_path,
        const char* proof_path
        );
