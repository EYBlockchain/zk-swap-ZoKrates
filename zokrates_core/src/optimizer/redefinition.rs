...
mod tests {
    ...
    fn remove_synonyms() {
        ...
        let optimized: Function<BN128> = Function {
            id: "foo".to_string(),
            arguments: vec![x],
    ...
    fn remove_multiple_synonyms() {
        ...
        let f: Function<BN128> = Function {
            ...
            statements: vec![
                Statement::definition(y, x),
                Statement::definition(t, BN128::from(1)),
                Statement::definition(z, y),
        ...
        let optimized: Function<BN128> = Function {
            ...
            statements: vec![
                ...
                Statement::definition(w, BN128::from(1)),
            ],
            returns: vec![z, w],
        };
    ...
    fn keep_existing_variable() {
        ...
        let f: Function<BN128> = Function {
            ...
            arguments: vec![x],
            statements: vec![
                Statement::constraint(x, BN128::from(1)),
                Statement::constraint(x, BN128::from(2)),
            ],
            returns: vec![x.into()],
        };
