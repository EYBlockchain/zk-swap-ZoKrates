...
extern "C" {
    ...
    fn _gm17_mnt4753_generate_proof(
        pk_path: *const c_char,
    ...
    fn _gm17_mnt4753_verify_proof(
        vk_path: *const c_char,
        proof_path: *const c_char,
    ) -> bool;
}

pub struct GM17_MNT4753 {}

impl GM17_MNT4753 {
    pub fn new() -> GM17_MNT4753 {
        GM17_MNT4753 {}
    }
}

impl ProofSystem for GM17_MNT4753 {
