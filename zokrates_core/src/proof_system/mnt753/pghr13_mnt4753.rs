...
use ir;
use proof_system::mnt753::utils::libsnark::{prepare_setup, prepare_generate_proof};
...
extern "C" {
    ...
    fn _pghr13_mnt4753_generate_proof(
        pk_path: *const c_char,
    ...
    fn _pghr13_mnt4753_verify_proof(
        vk_path: *const c_char,
        proof_path: *const c_char,
    ) -> bool;
}

pub struct PGHR13_MNT4753 {}

impl PGHR13_MNT4753 {
    pub fn new() -> PGHR13_MNT4753 {
        PGHR13_MNT4753 {}
    }
}

impl ProofSystem for PGHR13_MNT4753 {
    ...
    fn generate_proof(
        ...
        unsafe {
            _pghr13_mnt4753_generate_proof(
                pk_path_cstring.as_ptr(),
