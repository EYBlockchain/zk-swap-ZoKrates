...
extern "C" {
    ...
    fn _pghr13_mnt6753_generate_proof(
        pk_path: *const c_char,
    ...
    fn _pghr13_mnt6753_verify_proof(
        vk_path: *const c_char,
        proof_path: *const c_char,
    ) -> bool;
}

pub struct PGHR13_MNT6753 {}

impl PGHR13_MNT6753 {
    pub fn new() -> PGHR13_MNT6753 {
        PGHR13_MNT6753 {}
    }
}

impl ProofSystem for PGHR13_MNT6753 {
    ...
    fn generate_proof(
        ...
        unsafe {
            _pghr13_mnt6753_generate_proof(
                pk_path_cstring.as_ptr(),
