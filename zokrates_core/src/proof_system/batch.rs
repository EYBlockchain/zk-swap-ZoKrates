...
extern "C" {
    ...
    fn _gm17_mnt4753_mnt6753_batch(
        vk_1_path: *const c_char,
        proof_1_path: *const c_char,
        vk_2_path: *const c_char,
        proof_2_path: *const c_char,
    ...
    fn _gm17_mnt6753_mnt4753_batch(
        vk_1_path: *const c_char,
        proof_1_path: *const c_char,
        vk_2_path: *const c_char,
        proof_2_path: *const c_char,
...
pub fn batch(
    ...
    match (scheme, from_curve, to_curve) {
        ("PGHR13", "MNT4", "MNT6") => unsafe {
        ...
        ("GM17", "MNT4", "MNT6") => unsafe {
            _gm17_mnt4_mnt6_batch(
                vk_1_path_cstring.as_ptr(),
                proof_1_path_cstring.as_ptr(),
                vk_2_path_cstring.as_ptr(),
                proof_2_path_cstring.as_ptr(),
        ...
        ("GM17", "MNT6", "MNT4") => unsafe {
            _gm17_mnt6_mnt4_batch(
                vk_1_path_cstring.as_ptr(),
                proof_1_path_cstring.as_ptr(),
                vk_2_path_cstring.as_ptr(),
                proof_2_path_cstring.as_ptr(),
        ...
        ("GM17", "MNT4753", "MNT6753") => unsafe {
            _gm17_mnt4753_mnt6753_batch(
                vk_1_path_cstring.as_ptr(),
                proof_1_path_cstring.as_ptr(),
                vk_2_path_cstring.as_ptr(),
                proof_2_path_cstring.as_ptr(),
        ...
        ("GM17", "MNT6753", "MNT4753") => unsafe {
            _gm17_mnt6753_mnt4753_batch(
                vk_1_path_cstring.as_ptr(),
                proof_1_path_cstring.as_ptr(),
                vk_2_path_cstring.as_ptr(),
                proof_2_path_cstring.as_ptr(),
