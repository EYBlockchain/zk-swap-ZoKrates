...
extern "C" {
    ...
    fn _gm17_mnt4_verify_proof(
        vk_path: *const c_char,
        proof_path: *const c_char,
    ) -> bool;
}

pub struct GM17_MNT4 {}

impl GM17_MNT4 {
    pub fn new() -> GM17_MNT4 {
        GM17_MNT4 {}
    }
}

impl ProofSystem for GM17_MNT4 {
