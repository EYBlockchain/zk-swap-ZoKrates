...
use ir;
use proof_system::sw6::utils::libsnark::{prepare_setup, prepare_generate_proof};
...
extern "C" {
    ...
    fn _pghr13_sw6_verify_proof(
        vk_path: *const c_char,
        proof_path: *const c_char,
    ) -> bool;
}

pub struct PGHR13_SW6 {}

impl PGHR13_SW6 {
    pub fn new() -> PGHR13_SW6 {
        PGHR13_SW6 {}
    }
}

impl ProofSystem for PGHR13_SW6 {
