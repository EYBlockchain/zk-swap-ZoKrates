...
use ir;
use proof_system::edwards::utils::libsnark::{prepare_setup, prepare_generate_proof};
...
extern "C" {
    ...
    fn _pghr13_edwards_generate_proof(
        pk_path: *const c_char,
    ...
    fn _pghr13_edwards_verify_proof(
        vk_path: *const c_char,
        proof_path: *const c_char,
    ) -> bool;
}

pub struct PGHR13_EDWARDS {}

impl PGHR13_EDWARDS {
    pub fn new() -> PGHR13_EDWARDS {
        PGHR13_EDWARDS {}
    }
}

impl ProofSystem for PGHR13_EDWARDS {
    ...
    fn generate_proof(
        ...
        unsafe {
            _pghr13_edwards_generate_proof(
                pk_path_cstring.as_ptr(),
